...
source("R/remaining_supplementary_outputs.R")
...
log_step("Remaining supplementary QC and ML sensitivity outputs", run_remaining_supplementary_outputs(cfg), required = FALSE)
